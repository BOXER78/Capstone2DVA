...
Mental health among teenagers has become a critical concern for educators, healthcare providers, and parents. This project aims to analyze the various lifestyle, social, and academic factors contributing to teenager mental health outcomes. By uncovering the primary drivers of anxiety, depression, and stress, stakeholders can design targeted interventions.

**Core Business Question**

> Which lifestyle and academic factors have the strongest correlation with adverse mental health outcomes in teenagers?

**Decision Supported**

> This analysis will enable school administrators and healthcare professionals to allocate counseling resources effectively and design early-intervention programs for at-risk teenagers.
...
|---|---|
| **Source Name** | Kaggle |
| **Direct Access Link** | student_mental_health_burnout.csv |
| **Row Count** | 150,001 |
| **Column Count** | 20 |
| **Time Period Covered** | Current (Cross-sectional) |
| **Format** | CSV |
...
|---|---|---|
| daily_study_hours | Hours spent studying | Used for correlation with mental health KPIs |
| stress_level | Self-reported stress (1-10) | Core mental health outcome KPI |
| burnout_level | Target variable for burnout segmentation | Target variable for segmentation |
| course | Course enrolled in | Used for segmentation/filtering |
